...
//        Student st = builder1.buildStudent();
        ...
        * How can we do it? */
        /* i) Student.createBuilder() will return a builder class,
        *       but setAge is returning void,
        *        What to do?
        *  ii) we return a same builder object from setAge() in Builder Class
        *       which is inside Student class*/
